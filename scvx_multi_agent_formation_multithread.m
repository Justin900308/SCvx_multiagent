...
for i=1:N
    for j=1:Num_agen
        hold on
        if j==1
            plot(X_out((2*j-1),i),X_out((2*j),i),'r.')
        elseif j==2
            plot(X_out((2*j-1),i),X_out((2*j),i),'g.')
        elseif j==3
            plot(X_out((2*j-1),i),X_out((2*j),i),'b.')
        elseif j==4
            plot(X_out((2*j-1),i),X_out((2*j),i),'c.')
        end
