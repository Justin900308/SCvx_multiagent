...
for iteration=1:10
    ...
    if iteration==1
        ...
        X_out=[X_out1(1:2,:);X_out2(3:4,:);X_out3(5:6,:);X_out4(7:8,:)];
...
for iteration=1:15
    ...
    minimize (  100*norm((u((2*j-1):(2*j),:)+w-V_des((2*j-1):(2*j),:)),1) + ...
        norm((X((2*j-1):(2*j),:)+d-X0((2*j-1):(2*j),:)),1) +  ...
        1000*lambda*sum(sum(abs(v)))  + 1000*lambda*(   sum(sum(max(s,0)))   ))
    ...
    Linear_cost(iteration)=(  100*norm((u((2*j-1):(2*j),:)+w-V_des((2*j-1):(2*j),:)),1) + ...
        norm((X((2*j-1):(2*j),:)+d-X0((2*j-1):(2*j),:)),1) +  ...
        1000*lambda*sum(sum(abs(v)))  + 1000*lambda*(   sum(sum(max(s,0)))   ));
